Tools of the Trade  Atomic Design by Brad Frost
===============================================
...
For developers, this type of format most likely looks familiar. If you’re not a developer, don’t freak out! Once you look beyond the curly braces and quotes, you’ll see that we’re defining a `hero` object (for the full-bleed hero area directly below the header) that has a `headline` value of “Lorem Ipsum”, and an `img` with a `src` value of “/images/sample/fpo\_hero.png”. We’re simply defining this object’s attributes and providing values for those attributes.
